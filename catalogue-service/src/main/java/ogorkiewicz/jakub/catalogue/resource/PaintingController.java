...
public class PaintingController {
    ...
    @ApiOperation(value = "Return all paintings")
    @GetMapping
    public ResponseEntity<List<SimplePaintingDto>> getPage() {
        List<SimplePaintingDto> paintings = requestTimer.getTimer("GET","get-all").record(() -> paintingService.getPaintings());;
